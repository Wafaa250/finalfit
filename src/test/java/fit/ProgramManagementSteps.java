...
public class ProgramManagementSteps {
    ...
    @Test
    public void testCreateProgramSuccess() {
        String result = ProgramManagement.createProgram("Pilates for Beginners", "4 weeks", "Strengthen core", "$80");
        assertEquals("Program created successfully", result);
    }

    @Test
    public void testCreateProgramFailure() {
        String result = ProgramManagement.createProgram("", "4 weeks", "Strengthen core", "$80");
        assertEquals("Program title is required", result);
    }
    @Test
    public void testEditProgramSuccess() {
        ProgramManagement.createProgram("Pilates for Beginners", "4 weeks", "Strengthen core", "$80");
        String result = ProgramManagement.editProgram("Pilates for Beginners", "6 weeks", "$100");
        assertEquals("Program updated successfully", result);
    }

    @Test
    public void testEditProgramNotFound() {
        String result = ProgramManagement.editProgram("Nonexistent Program", "6 weeks", "$100");
        assertEquals("Program not found", result);
    }
    @Test
    public void testDeleteProgramSuccess() {
        ProgramManagement.createProgram("Pilates for Beginners", "4 weeks", "Strengthen core", "$80");
        String result = ProgramManagement.deleteProgram("Pilates for Beginners");
        assertEquals("Program deleted successfully", result);
    }

    @Test
    public void testDeleteProgramNotFound() {
        String result = ProgramManagement.deleteProgram("Nonexistent Program");
        assertEquals("Program not found", result);
    }
    @Test
    public void testIOExceptionHandling() {
        String invalidFilePath = "invalid/path/to/programs.txt";
        File file = new File(invalidFilePath);
        String result = ProgramManagement.deleteProgram("Nonexistent Program");
        assertTrue(result.startsWith("Error reading programs:"));
    }
